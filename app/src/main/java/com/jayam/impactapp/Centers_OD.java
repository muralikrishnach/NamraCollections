...
import com.jayam.impactapp.adapters.CentersAdapter_OD;
...
public class Centers_OD extends Base
{
	public static final int RequestPermissionCode = 1;
	Context mContext;
	private LinearLayout llCenters;
	private ListView lvCenters;
	private CentersAdapter_OD centersAdapter_OD;
	GPSTrackevalue gps;
	String  latitude="";
	String longitude="";
	@Override
	...
	{
		mContext=Centers_OD.this;
		gps = new GPSTrackevalue(Centers_OD.this);
		...
		if (ContextCompat.checkSelfPermission(mContext, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(mContext, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
			ActivityCompat.requestPermissions(Centers_OD.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, 1);
		...
		ArrayList<ODDemandsDO> alArrayList = odDemandsBL.SelectAllCenters(Centers_OD.this);
		centersAdapter_OD = new CentersAdapter_OD(Centers_OD.this, alArrayList,latitude,longitude);
		lvCenters.setAdapter(centersAdapter_OD);
		...
		ivLogout.setOnClickListener(new OnClickListener() 
		{
			...
			public void onClick(View v)
			{
				Intent i = new Intent(Centers_OD.this,loginActivity.class);
				startActivity(i);
