...
import com.jayam.impactapp.adapters.GroupsAdapter;
import com.jayam.impactapp.adapters.LateGroupsAdapter;
...
public class LateGroups extends Base
{
    public static final int RequestPermissionCode = 1;
    private LinearLayout llGroups;
    private ListView lvGroups;
    private LateGroupsAdapter groupsAdapter;
    ...
    {
        mContext=LateGroups.this;
        centernuber		=	getIntent().getExtras().getString("centercode");
        Log.v("","centernuber"+centernuber);
        checkAndRequestPermissions();

        gps=new GPSTrackevalue(LateGroups.this);
        ...
        if (ContextCompat.checkSelfPermission(mContext, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(mContext, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(LateGroups.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, 1);
        ...
        alRegularDemandsDOs = regularDemandsBL.SelectGroupsLate(centernuber,LateGroups.this);
        ...
        ivLogout.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent i = new Intent(LateGroups.this,loginActivity.class);
                startActivity(i);
    ...
    public void intializeControlles()
    {
        ...
        groupsAdapter = new LateGroupsAdapter(LateGroups.this, null, centernuber,latitude,longitude);
        lvGroups.setAdapter(groupsAdapter);
        svBase.setVisibility(View.GONE);
        llBaseMiddle_lv.setVisibility(View.VISIBLE);
        llBaseMiddle_lv.addView(llGroups, ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.FILL_PARENT);
        showHomeIcons();
