...
import com.jayam.impactapp.adapters.GroupsAdapter_Centerwise;
...
public class Groups_Centerwise extends Base
{
	public static final int RequestPermissionCode = 1;
	private LinearLayout llGroups;
	private ListView lvGroups;
	private GroupsAdapter_Centerwise groupsAdapter;
	...
	{
		mContext=Groups_Centerwise.this;
		centernumber		=	getIntent().getExtras().getString("centernuber");
		checkAndRequestPermissions();
		gps=new GPSTrackevalue(Groups_Centerwise.this);
		...
		if (ContextCompat.checkSelfPermission(mContext, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(mContext, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
			ActivityCompat.requestPermissions(Groups_Centerwise.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, 1);
		...
		alRegularDemandsDOs = regularDemandsBL.SelectGroups(centernumber,Groups_Centerwise.this);
		...
		ivLogout.setOnClickListener(new OnClickListener() 
		{
			...
			public void onClick(View v)
			{
				Intent i = new Intent(Groups_Centerwise.this,loginActivity.class);
				startActivity(i);
	...
	public void intializeControlles()
	{
		...
		groupsAdapter = new GroupsAdapter_Centerwise(Groups_Centerwise.this, null,latitude,longitude);
