...
public class FtodCenterWiseConfirmation extends Base {
	...
	CenterCode = getIntent().getExtras().getString("Code");
	Log.e("Center Code2", CenterCode);
	...
	ivLogout.setOnClickListener(new OnClickListener() {
	    @Override
	    public void onClick(View v) {
		Intent i = new Intent(FtodCenterWiseConfirmation.this, loginActivity.class);
		startActivity(i);
		...
		showAlertDailog("OD Reason captured. Do you want to continue?", "Yes", "No", new CustomDailoglistner() {
			...
			showAlertDailog("Are you sure that you want to mark these accounts as OD Accounts?", "OK",
				...
				showAlertDailog("Are you sure to mark OD?", "OK", "cancel", new CustomDailoglistner() {
					...
					FTODBL.updateFTODReasons(CenterCode, ID, Remarks, "null", "Center",FtodCenterWiseConfirmation.this);
					regularDemandsBL = new RegularDemandsBL();
					alregularDemandsBL = regularDemandsBL.SelectAll(CenterCode, "CNo",FtodCenterWiseConfirmation.this);
					NoPayment_center noPayment = new NoPayment_center(alregularDemandsBL,
						...
						HideLoader();
						showAlertDailog("Center OD Marked Successfully.", "OK",
					...
					}, FtodCenterWiseConfirmation.this, CenterCode);
