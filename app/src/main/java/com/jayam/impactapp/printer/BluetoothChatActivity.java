...
public class BluetoothChatActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int fontSize   = getIntent().getExtras().getInt("fntsize");
        
        Log.e("address", ""+address);
        Log.e("message", ""+message);
        Log.e("fontSize", ""+fontSize);
...
//       
//        searchDevice=(Button) findViewById(R.id.btnSearch);
...
//        connectDevice(address, message, fontSize);
    }
...
//    }
    ...
    private void connectDevice(String address, PrintDetailsDO detailsDO) {
...
//        String address = data.getExtras() .getString(DeviceListActivity.EXTRA_DEVICE_ADDRESS);
        ...
        mChatService.connect(device, detailsDO);
    }
