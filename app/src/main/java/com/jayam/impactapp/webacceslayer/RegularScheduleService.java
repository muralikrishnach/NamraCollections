        ...
        Timer t = new Timer();
                t.scheduleAtFixedRate(new TimerTask() {
                                  ...
                                  public void run() {
                                      ...
                                      alRegularDemands = trnsactionsBL.SelectAllFlagwise(RegularScheduleService.this);
                                      alIntialParametrsDOs = intialParametrsBL.SelectAll(RegularScheduleService.this);
                                      ...
                                      if(alRegularDemands!=null&&alRegularDemands.size()>0)
                                      {
                                          ...
                                          if(alRegularDemands!=null)
                                          {
                                              try
                                              {
                                                  ...
                                                  TOTAL_ACCOUNTS_REG = regularDemandsBL.getTOTALRegularAccountsGroupId(GroupId,RegularScheduleService.this);
                                                  TOTAL_AMT_UPLOADED_REG = regularDemandsBL.getTOTALDemandAmountForRegularGroupId(GroupId,RegularScheduleService.this);
                                   ...
                                   Log.v("","regcount"+regcount);
                                      if (regcount > 0) {
                                          ...
                                          if(Rcollection!=null&&!Rcollection.isEmpty())
                                          {
                                              ...
                                              {
                                                  trnsactionsBL.UpdateRegCollection(GroupId,"P", UtilClass.UploadCurrentDate(),RegularScheduleService.this);
            ...
            if (result != null) {
                if(!result.isEmpty())
                {
                    ...
                    Log.v("","Message"+Message);
                        ...
                        {
                            trnsactionsBL.InsertServerCollectionUploadData("RCollectiion",TOTAL_ACCOUNTS_REG,TOTAL_AMT_UPLOADED_REG,data,RegularScheduleService.this);
                            regularDemandsBL.TruncatetabelGroupId(Message,RegularScheduleService.this);
                            trnsactionsBL.TruncatetabelGroupId(Message,RegularScheduleService.this);
                            demandsBLTemp.TruncatetabelGroupId(Message,RegularScheduleService.this);
