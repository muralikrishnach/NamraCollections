...
public class AdvanceGroupDetails  extends Base
{
	...
	public void initialize()
	{
		...
		alAdvanceDemandsBL = andanceDemandsBL.SelectAll(groupnumber, "Groups",AdvanceGroupDetails.this);
		...
		etEdit.setOnClickListener(new OnClickListener()
		{
			...
			{
				Intent intent = new Intent(AdvanceGroupDetails.this, AdvGroupMembers.class);
		...
		btnNext.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				...
				String CollAmt = advanceDemandBL.getTOTALCollectedAmount(groupnumber,"Group",AdvanceGroupDetails.this);

				Log.v("","CollAmt---"+CollAmt);
				if(CollAmt==null)
				{
					CollAmt="0";
				}

				if(CollAmt!=null&&CollAmt.equals("0.0") ||CollAmt!=null&& CollAmt.equals("0"))
				{
				...
				else
				{
					...
					String GroupName=alAdvanceDemandsBL.get(0).MGI_Name;
					String GroupCode=alAdvanceDemandsBL.get(0).MGI_Code;
					Intent intent = new Intent(AdvanceGroupDetails.this, AdvanceConfirmationScreen.class);
		...
		ivLogout.setOnClickListener(new OnClickListener() 
		{
			...
			public void onClick(View v)
			{
				Intent i = new Intent( AdvanceGroupDetails.this,loginActivity.class);
				startActivity(i);
