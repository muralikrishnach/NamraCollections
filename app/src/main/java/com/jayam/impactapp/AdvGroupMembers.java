...
public class AdvGroupMembers extends Base
{
	...
	{
		mContext=AdvGroupMembers.this;
		gps=new GPSTrackevalue(AdvGroupMembers.this);
		...
		if (ContextCompat.checkSelfPermission(mContext, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(mContext, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
			ActivityCompat.requestPermissions(AdvGroupMembers.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, 1);
		...
		ArrayList<AdvaceDemandDO> alAdvanceDemandsDOs = advanceDemandsBL.SelectAll(groupnumber,"Groups",AdvGroupMembers.this);
	...
	public void intializeControlles()
	{
		...
		groupMembersAdapter = new AdvGroupMembersAdapter(AdvGroupMembers.this, null,latitude,longitude);
