...
public class Groups extends Base
{
	...
	public void initialize()
	{
		...
		if (ContextCompat.checkSelfPermission(mContext, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(mContext, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
			ActivityCompat.requestPermissions(Groups.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, 1);
		...
		alRegularDemandsDOs = regularDemandsBL.SelectGroups(centernuber,Groups.this);
		...
		ivLogout.setOnClickListener(new OnClickListener() 
		{
			...
			public void onClick(View v)
			{
				Intent i = new Intent(Groups.this,loginActivity.class);
				startActivity(i);
	...
	public void intializeControlles()
	{
		...
		groupsAdapter = new GroupsAdapter(Groups.this, null, centernuber,latitude,longitude);
