...
import com.jayam.impactapp.Groups_OD;
...
public class CentersAdapter_OD extends GenericAdapter {
	public String langitude, latitude;
	public	String dlatitude, dlangitude;

    public CentersAdapter_OD(Context context, List<? extends BaseDO> listItems,String latitude,String langitude) {
	...
	tvCenterName.setText("" + odDemandsDO.MCI_Name);
		...
		dlangitude=odDemandsDO.LongitudeCenter;
		dlatitude=odDemandsDO.LatitudeCenter;
	...
	convertView.setOnClickListener(new OnClickListener() {
		...
		Intent intent = new Intent(mContext, Groups_OD.class);
		intent.putExtra("centercode", obj.MCI_Code);
