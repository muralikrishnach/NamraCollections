...
public class GroupsAdapter extends GenericAdapter {
    String cno;
	public String langitude, latitude;
	public	String dlatitude, dlangitude;
    public GroupsAdapter(Context context, List<? extends BaseDO> listItems, String cno,String latitude,String langitude) {
	...
	convertView.setOnClickListener(new OnClickListener() {
	    ...
	    public void onClick(View v) {
		RegularDemandsBL bl = new RegularDemandsBL();
		String count = bl.getDistinctCount(cno,mContext);
		Boolean b = false;
