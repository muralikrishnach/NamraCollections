...
import com.jayam.impactapp.AdvGroupDetails_Centerwise;
...
public class AdvGroupsAdapter_Centerwise extends GenericAdapter {
	public String langitude, latitude;
	public	String dlatitude, dlangitude;
    public AdvGroupsAdapter_Centerwise(Context context, List<? extends BaseDO> listItems,String latitude,String langitude) {
	...
	convertView.setOnClickListener(new OnClickListener() {
		...
		Intent intent = new Intent(mContext, AdvGroupDetails_Centerwise.class);
