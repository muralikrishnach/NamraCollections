...
import com.jayam.impactapp.CollectionReports_Members_OD;
...
public class CollectionReportFor_Groups_OD_Adapter extends GenericAdapter {

    public CollectionReportFor_Groups_OD_Adapter(Context context, List<? extends BaseDO> listItems) {
	...
	tvCenterName.setText("" + odDemandsDO.MGI_Name + "-" + odDemandsDO.collectedAmt + "");
	...
	convertView.setOnClickListener(new OnClickListener() {
		...
		Intent intent = new Intent(mContext, CollectionReports_Members_OD.class);
