...
public class CenterAdapter extends GenericAdapter {
    private String type;
	public String langitude, latitude;
	public	String dlatitude, dlangitude;
    public CenterAdapter(Context context, List<? extends BaseDO> listItems, String type,String latitude,String langitude) {
	...
	String fullpaymnet = bl.CheckForFullpayMent_Centerwise(regularDemandsDO.CNo,mContext);
	...
	convertView.setOnClickListener(new OnClickListener() {
		...
		if (type.equalsIgnoreCase("center")) {
		    ...
		    Intent intent = new Intent(mContext, CenterDetails.class);
		    ...
		    intent.putExtra("centernuber", regularDemandsDO.CNo);
		    ((Activity) (mContext)).startActivityForResult(intent, 0);
		}
