...
import com.jayam.impactapp.adapters.LateCenterAdapter;
...
public class LateCenters extends Base

    {
        private LinearLayout llCenters;
        private ListView lvCenters;
        private String date, type;
        private LateCenterAdapter centerAdapter;
        ...
        mContext= LateCenters.this;
        gps = new GPSTrackevalue(LateCenters.this);
        ...
        if (ContextCompat.checkSelfPermission(mContext, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(mContext, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(LateCenters.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, 1);
        ...
        alRegularDemandsDOs = regularDemandsBL.SelectAllCentersLate(LateCenters.this);
        centerAdapter = new LateCenterAdapter(LateCenters.this, null, type,latitude,longitude);
        ...
        ivLogout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(LateCenters.this, loginActivity.class);
                startActivity(i);
        ...
        llBaseMiddle_lv.addView(llCenters, ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.FILL_PARENT);
        showHomeIcons();
