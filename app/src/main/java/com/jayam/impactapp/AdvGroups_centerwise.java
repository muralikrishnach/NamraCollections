...
public class AdvGroups_centerwise extends Base
{
	...
	{
		mContext=AdvGroups_centerwise.this;
		gps=new GPSTrackevalue(AdvGroups_centerwise.this);
		...
		if (ContextCompat.checkSelfPermission(mContext, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(mContext, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
			ActivityCompat.requestPermissions(AdvGroups_centerwise.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, 1);
		...
		alAdvanceDemandsDOs = advanceDemandsBL.SelectGroups(centernuber,AdvGroups_centerwise.this);
	...
	public void intializeControlles()
	{
		...
		groupsAdapter = new AdvGroupsAdapter_Centerwise(AdvGroups_centerwise.this, null,latitude,longitude);
