...
public class ODCASHLESSPending extends Base {
    ODDemandsDO cbmdao;
    ...
    HashMap<String, ODDemandsDO> hmcentermap;
    private ArrayAdapter<String> centeradapter;
    ODDemandsDO centerdao;
    String centerid, groupid,memberid;
    String centerbyid = "";
    String groupbyid = "";
    Date finalsdate;
    ArrayList<ODDemandsDO> centerlistdata,grouplist,memberlistdata,membergrid;




    HashMap<String, ODDemandsDO> hmgroupmap;
    HashMap<String, ODDemandsDO> hmmembermap;
    ...
    ODDemandsDO groupdao;
    ODDemandsDO memberdao;
    ...
    public void initialize() {
        userID = SharedPrefUtils.getKeyValue(ODCASHLESSPending.this, AppConstants.pref_name, AppConstants.username);
        try {
    ...
    private void oncreatingViews() {
        ...
        for (int i = 0; i < membergrid.size(); i++) {
            final ODDemandsDO adkyc = (ODDemandsDO) membergrid.get(i);
            ...
            CBsummary.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(final View arg0) {
                    ...
                    if (NetworkUtility.isNetworkConnectionAvailable(ODCASHLESSPending.this))
                    {
    ...
    private void initializecontrols() {
        ...
        ODCASHLESSPending.this.getWindowManager().getDefaultDisplay().getMetrics(metrics);
...
//            setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        ...
        centerlistdata=mdb.SelectAllCenterCashlesspendingOD(ODCASHLESSPending.this);

        if (centerlistdata != null && !centerlistdata.isEmpty()) {
            String[] vistleadvalues = new String[centerlistdata.size()];
            hmcentermap = new HashMap<String, ODDemandsDO>();
            for (int i = 0; i < centerlistdata.size(); i++) {
                ODDemandsDO vlead = centerlistdata.get(i);
                String value=vlead.MCI_Name;
                Log.v("","value"+value);
                vistleadvalues[i] = vlead.MCI_Name;
                centercheck.add(vlead.MCI_Name);
                hmcentermap.put(vlead.MCI_Code, vlead);
                hmcentermap.put(vlead.MCI_Name, vlead);
            }


            if (vistleadvalues.length > 0) {
                Log.v("","vistleadvalueslength"+vistleadvalues.length);
                centeradapter = new ArrayAdapter<String>(ODCASHLESSPending.this, R.layout.mylistdata, vistleadvalues);
        ...
        center.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                if (centeradapter != null && !centeradapter.isEmpty())
                {
                    ...
                    if(centerdao!=null)
                    {
                        String gropname = centerdao.MCI_Name;
                        ...
                        grouplist=mdb.SelectAllGroupCashlesspendingOD(centerid,ODCASHLESSPending.this);
                        Log.v("","grouplistsize"+grouplist.size());

                        if (grouplist != null && !grouplist.isEmpty()) {
                            String[] vistleadvalues = new String[grouplist.size()];
                            hmgroupmap = new HashMap<String, ODDemandsDO>();
                            for (int i = 0; i < grouplist.size(); i++) {
                                ODDemandsDO vlead = grouplist.get(i);
                            ...
                            if (vistleadvalues.length > 0) {
                                Log.v("","vistleadvalueslength"+vistleadvalues.length);
                                groupadapter = new ArrayAdapter<String>(ODCASHLESSPending.this, R.layout.mylistdata, vistleadvalues);
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                if (groupadapter != null && !groupadapter.isEmpty())
                {
                    ...
                    if(groupdao!=null)
                    {
                        ...
                        memberlistdata=mdb.SelectAllMemberCashlesspendingODMEMBER(groupid,ODCASHLESSPending.this);
                        ...
                        if (memberlistdata != null && !memberlistdata.isEmpty()) {
                            ...
                            hmmembermap = new HashMap<String, ODDemandsDO>();
                            for (int i = 0; i < memberlistdata.size(); i++) {
                                ODDemandsDO vlead = memberlistdata.get(i);
                            ...
                            if (vistleadvalues.length > 0) {
                                Log.v("","vistleadvalueslength"+vistleadvalues.length);
                                memberadapter = new ArrayAdapter<String>(ODCASHLESSPending.this, R.layout.mylistdata, vistleadvalues);
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                if (memberadapter != null && !memberadapter.isEmpty())
                {
                    ...
                    if(memberdao!=null)
                    {
                        ...
                        Toast.makeText(ODCASHLESSPending.this,"memberid.()"+memberid,Toast.LENGTH_LONG).show();

                        membergrid=mdb.SelectAllMeberdetailsOD(memberid,ODCASHLESSPending.this);
                        Log.v("","memberlistdata"+memberlistdata.size());

                        Toast.makeText(ODCASHLESSPending.this,"membergridsize"+membergrid.size(),Toast.LENGTH_LONG).show();
...
//			    }
        ...
        protected void onPostExecute(ArrayList<cbsearchgrid> result) {
            ...
            if (result != null) {
                ...
                if (!ODCASHLESSPending.this.isFinishing()) {
                    HideLoader();
